...
```bash
helm install open-terminal oci://ghcr.io/qaoru/helm-charts/open-terminal --version 0.2.0
```

Or with a local `values.yaml`:

```bash
helm install open-terminal oci://ghcr.io/qaoru/helm-charts/open-terminal --version 0.2.0 -f values.yaml
```
